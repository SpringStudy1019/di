...
public class TrieAlgorithmUtil {
	...
	public Node search(String str) {
		...
		for (int i = 0; i < str.length(); i++) {
			node = node.chiledNode.getOrDefault(str.charAt(i), null);	// 문자열의 각 단어에 매핑된 노드가 존재하면 가져오고 아니면 null
	 ...
	 */
	public List<String> autoComplete(String str, Node node) {
		autoCompleteStr = new ArrayList<String>();
