...
public class ScoreCountResponse {
	...
	public ScoreCountResponse(Integer contentId, Integer scoreOneCount, Integer scoreTwoCount, Integer scoreThreeCount,
			Integer scoreFourCount, Integer scoreFiveCount) {
		super();
