...
@Slf4j
@SpringBootTest(properties = { "spring.config.location=classpath:application-test.properties" }, classes = {
...
class AttractionServiceImplTest {
	...
	void testFindBookmarkAndAttractionByUserIds() throws Exception {
		...
		// when
		List<AttractionBookmarkResponse> attractionBookmarkResponse = attractionService
				.findBookmarkAndAttractionByUserIds(planIdx);
