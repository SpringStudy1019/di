...
public class PlanControllerTest {
	...
	void testGetSelectAttractionPlan() throws Exception {
		...
		// when, then
		mockMvc.perform(get("/plans/" + attractionPlanId)).andExpect(status().isOk())
	...
	void testGetModifyPlan() throws Exception {
		...
		// when, then
		mockMvc.perform(get("/plans/modify/" + planIdx)).andExpect(status().isOk())
				.andExpect(content().contentType(MediaType.APPLICATION_JSON)).andDo(print());
	}
	...
	void testGetInvitedPlans() throws Exception {
		...
		// when, then
		mockMvc.perform(get("/plans/invite/" + userId)).andExpect(status().isOk())
				.andExpect(content().contentType(MediaType.APPLICATION_JSON)).andDo(print());
	}
}
